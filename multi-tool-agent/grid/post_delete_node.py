...
def post_delete_node(bus_name: str) -> Dict[str, Any]:
    """
    Deletes a household (bus/node) by sending a POST request to the OpenDSS endpoint.

    Args:
        bus_name (str): Name of the bus/node to delete.
